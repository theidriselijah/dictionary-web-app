    ...
    <div className="flex justify-between mb-6">
        ...
        <div className="flex items-center">
            <div className="flex relative min-w-[120px] h-6">
                <select name="font" id="font" value={props.value} onChange={props.selectHandleChange} className="outline-none appearance-none w-full text-xl bg-[#FEFEFE] dark:bg-[#000000]">
