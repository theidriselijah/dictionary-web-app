      ...
      <div className="flex items-center">
        <div className="flex relative min-w-[120px] h-6">
          <select
            ...
            id="font"
            value={props.value}
            onChange={props.selectHandleChange}
            aria-label="font"
            className="outline-none appearance-none w-full text-xl bg-[#FEFEFE] dark:bg-[#000000]"
          >
        ...
        <div className="flex">
          <div className="flex">
            ...
            <label
              htmlFor="check"
              className="bg-[#757575] w-10 h-5 rounded-full cursor-pointer relative duration-200 before:absolute before:content-[''] before:bg-[#FFFFFF] before:w-3.5 before:h-3.5 before:rounded-full before:m-[3px] before:duration-200 toggle"
            ></label>
          </div>
          <Image
            src="/icon-moon.svg"
